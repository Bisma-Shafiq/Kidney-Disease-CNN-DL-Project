...
from src.CNN_Classification.entity.config_entity import PrepareBaseModelConfig , TrainingConfig, EvaluationConfig
import os
...
class ConfigurationManager:
    ...
    def get_evaluation_config(self) -> EvaluationConfig:
        eval_config = EvaluationConfig(
            ...
            mlflow_uri="https://dagshub.com/Bisma-Shafiq/Kidney-Disease-CNN-DL-Project.mlflow",
